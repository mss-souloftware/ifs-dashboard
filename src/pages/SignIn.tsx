...
import LogoDark from '../images/logo/logo.webp';
...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/api/${VERSION}/users/auth/login`, {
        method: 'POST',
        headers: {
      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="mb-5.5 inline-block bg-black-2" to="/">
              <img className="hidden dark:hidden" src={Logo} alt="Logo" />
              <img className="dark:block" src={LogoDark} alt="Logo" />
            </Link>
